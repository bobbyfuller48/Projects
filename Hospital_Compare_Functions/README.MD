...
Repository contains functions (see 'Function Examples.R') that work on "outcome-of-care-measures.csv" file containing [data](https://data.cms.gov/provider-data/?redirect=true) from the Centers for Medicare & Medicaid Services web site run by the U.S. Department of Health and Human Services. 
